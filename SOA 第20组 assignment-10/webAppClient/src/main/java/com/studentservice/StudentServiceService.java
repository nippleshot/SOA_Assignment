 ...
 * 
 */
@WebServiceClient(name = "StudentServiceService", targetNamespace = "http://studentservice.com/", wsdlLocation = "http://localhost:8888/StudentService/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICESERVICE_QNAME = new QName("http://studentservice.com/", "StudentServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/StudentService/?wsdl");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://studentservice.com/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://studentservice.com/", "StudentServicePort"), StudentService.class, features);
    }
